...
void GenericPhotosensor::Construct()
{
  ...
  G4double energy[]       = {11.500*eV, 3.875*eV, 3.836*eV, 3.815*eV, 3.794*eV, 3.773*eV, 
                            ...
                            1.436*eV, 1.418*eV, 1.401*eV, 1.382*eV, 0.200*eV};
  ...
  G4double efficiency[]   = {0.026, 0.026, 0.037, 0.046, 0.055, 0.068, 0.08, 0.09, 0.099, 0.119, 
                            ...
                            0.076, 0.071, 0.066, 0.059, 0.053, 0.048, 0.044, 0.039, 0.035, 0.035};
